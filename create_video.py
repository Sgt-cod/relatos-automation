...
# (logo após a função upload_to_youtube)
    ...
    # SUBSTITUA a função send_download_link() no create_video.py
...
📦 <b>DOWNLOAD PARA OUTRAS REDES:</b>

⚠️ O vídeo é muito grande para envio direto pelo Telegram ({video_size_mb:.1f}MB).

📥 <b>Link de download:</b>
{download_url}

<b>INSTRUÇÕES:</b>
1️⃣ Clique no link acima para baixar
2️⃣ Aguarde o download completar
3️⃣ Clique no botão abaixo para confirmar
4️⃣ O vídeo será removido do servidor
