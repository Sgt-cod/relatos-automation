...
def generate_hook_text(source_meta: dict, transcript_excerpt: str) -> str:
    ...
    prompt = (
        ...
        "- Não invente fatos que não estejam no trecho, pode usar "
        "rótulos político-ideológicos caso se refira a esquerda, como esquerdista.\n"
        "- Pode usar um ângulo de curiosidade/impacto "
